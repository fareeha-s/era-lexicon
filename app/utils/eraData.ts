...
const ERA_TERMS: Record<string, { text: string; count: number }[]> = {
  ...
  // 2022-2024: AI boom, mainstream TikTok, post-pandemic
  '2022-2024': [
    { text: 'chatgpt', count: 102 },
    { text: 'ai', count: 95 },
    { text: 'midjourney', count: 88 },
    { text: 'bereal', count: 82 },
    { text: 'threads', count: 77 },
    { text: 'rizz', count: 71 },
    { text: 'slay', count: 66 },
    { text: 'bussin', count: 61 },
    { text: 'sheesh', count: 56 },
    { text: 'delulu', count: 51 },
    { text: 'unhinged', count: 46 },
    { text: 'gaslighting', count: 41 },
    { text: 'situationship', count: 37 },
    { text: 'beige flag', count: 32 },
    { text: 'red flag', count: 28 },
  ],
  
  // 2025-2026: Current era - Updated Jan 2026
  '2025-2026': [
    { text: 'tiktok ban', count: 98 },
    { text: 'deepseek', count: 95 },
    { text: 'ai agents', count: 90 },
    { text: 'sora', count: 85 },
    { text: 'rotmaxxing', count: 80 },
    { text: 'demure', count: 75 },
    { text: 'brat', count: 70 },
    { text: 'hawk tuah', count: 65 },
    { text: 'moo deng', count: 60 },
    { text: 'pookie', count: 55 },
    { text: 'delulu', count: 50 },
    { text: 'ate', count: 45 },
    { text: 'slay', count: 40 },
    { text: 'understood the assignment', count: 35 },
    { text: 'its giving', count: 30 },
  ],
}
