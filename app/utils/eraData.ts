...
const ERA_TERMS: Record<string, { text: string; count: number }[]> = {
  ...
  // 2025-2026: Current era - mainstream viral content
  '2025-2026': [
    { text: 'wicked', count: 100 },
    { text: 'squid game', count: 95 },
    { text: 'moana 2', count: 90 },
    { text: 'tiktok ban', count: 88 },
    { text: 'wrapped', count: 85 },
    { text: 'moo deng', count: 82 },
    { text: 'demure', count: 78 },
    { text: 'brat', count: 75 },
    { text: 'skibidi', count: 72 },
    { text: 'hawk tuah', count: 68 },
    { text: 'very mindful', count: 65 },
    { text: 'brain rot', count: 62 },
    { text: 'ate', count: 58 },
    { text: 'slay', count: 55 },
