...
const ERA_TERMS: Record<string, { text: string; count: number }[]> = {
  ...
  '2025-2026': [
    ...
    { text: 'brat summer', count: 87 },
    { text: 'demure', count: 81 },
    { text: 'skibidi', count: 76 },
    { text: 'rizz', count: 71 },
    { text: 'sigma', count: 66 },
    { text: 'gyatt', count: 61 },
    { text: 'ohio', count: 56 },
    { text: 'brain rot', count: 51 },
    { text: 'aura', count: 46 },
    { text: 'cooked', count: 41 },
    { text: 'locked in', count: 37 },
    { text: 'mogging', count: 32 },
    { text: 'mewing', count: 28 },
  ],
}
